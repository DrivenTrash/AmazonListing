/**
 * Script-Name: Amazon Bilderlinks X
 * Version: 0.2
...
const Rules: Rule[] = [
    {
        ...
        value: (ctx: Context, row: number) => {
            ...
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + ".jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_a.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_b.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_c.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_d.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_e.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_f.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_g.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
    {
        ...
        value: (ctx: Context, row: number) => {
            const temp = String(ctx.sku[row - (firstDataRow - 1)]).toLowerCase();
            if (temp == null) { return "ERROR" }
            let loc = String("https://www.heomedia.com/img/nrm/x_" + temp + "_h.jpg");
            return loc;
        },
        appliesTo: ["ALL"]
    },
